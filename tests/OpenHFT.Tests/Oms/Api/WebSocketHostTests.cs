...
public class WebSocketHostTests
{
    ...
    {
        // --- Arrange ---
        var parameters = new QuotingParameters(123, "test", FairValueModel.Midp, 124, 1m, -1m, 1m, Quantity.FromDecimal(2m), 1, QuoterType.Single, QuoterType.Single, true, Quantity.FromDecimal(6m), Quantity.FromDecimal(6m), HittingLogic.AllowAll);
