...
description: >
  ...
  WebApplicationFactory and Testcontainers, NUnit patterns, and snapshot
...
2. `testing` — NUnit, WebApplicationFactory, Testcontainers, Verify, AAA pattern
